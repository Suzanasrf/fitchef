...
<div class="container ingredientes">
  <div class="row ">
    <div class="col-sm-3">
      ...
      <a href="<?php echo $url; ?>/ingrediente" class="prato-feito-opcao"> <img src="<?php echo $url; ?>/img/mignon.jpg" class="card-img-top" alt="...">
         <div class="card-body">
    ...
    <div class="col-sm-3">
      <div class="card" style="width: 15rem; height: 20rem;">
      <a href="<?php echo $url; ?>/ingrediente" class="prato-feito-opcao"> <img src="<?php echo $url; ?>/img/porco.jpg" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col-sm-3">
      <div class="card" style="width: 15rem; height: 20rem;">
      <a href="<?php echo $url; ?>/ingrediente" class="prato-feito-opcao"> <img src="<?php echo $url; ?>/img/salmao.jpg" class="card-img-top" alt="...">
        <div class="card-body">
    ...
    <div class="col-sm-3">
      <div class="card" style="width: 15rem; height: 20rem;">
      <a href="<?php echo $url; ?>/ingrediente" class="prato-feito-opcao"> <img src="<?php echo $url; ?>/img/quinoa.jpg" class="card-img-top" alt="...">
        <div class="card-body">
